...
const MultiSender = () => {
    return (<div className="min-h-[1500px]">
        <div class="p-8 rounded-2xl bg-[#1B1B1B] flex flex-col justify-between relative mt-8 lg:mt-0">
            <div class="flex flex-row justify-between items-center pl-12 pr-[36px]">
                <div class="w-[42px] h-[42px] bg-[#C03F4A] flex flex-row justify-center items-center rounded-full text-base">1</div>
                <hr class="flex-1 bg-[#2C2C2C] h-[2px] border-none"/>
                    <div class="w-[42px] h-[42px] bg-[#86888C] flex flex-row justify-center items-center rounded-full text-base">2</div>
                </div>
                <div class="flex flex-row justify-between items-center w-full mt-8">
                    <div class="flex flex-col items-center  gap-2">
                        <p class="text-white text-base">Add Your Allocation</p>
                        <p class="text-white/[0.45] text-[14px] text-center">Enter your token to be <br />
                            send with allocations</p>
                        </div>
                        <div class="flex flex-col items-center gap-2">
                            <p class="text-white text-base">Confirmation</p>
                            <p class="text-white/[0.45] text-[14px] text-center">Let review your<br/> information</p>
                        </div>
                    </div>
                </div>
