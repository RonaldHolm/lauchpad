...
const FooterButton = () => {
  return (
    <div className="flex flex-row gap-6 justify-end max-sm:flex-row-reverse">
      ...
      <button className="px-8 py-4 border border-[#C03F4A] bg-[#C03F4A] rounded-[8px] text-center text-[#16171B] text-[20px] max-sm:text-sm max-sm:px-6">
        Create Token
      </button>
    </div>
  );
        ...
        <div>
          <Success>
            <p className="text-white text-[14px]">
              ...
              Audits can be found <span className="text-[#C03F4A]">here</span>.
